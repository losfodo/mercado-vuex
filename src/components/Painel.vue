<template>
    <div class="painel">
        <div class="cabecalho">
            ...
            <span class="notificacao" v-if="notificacao"> <!--notificação interpolada, numero de itens que tem no carrinho..-->
                {{ notificacao }}
            </span>
        </div>
        <div class="conteudo">
            <slot></slot><!--conteudo do componente é passado via slot-->
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .notificacao {/*notificação class css */
        display: flex;
        justify-content: center;
        align-items: center;
        font-size: 1.6rem;
...
/*painel classe global que cobre todas classe .cabeçalho interna a painel com corres especifico de cada um */
